...
export default function Projects({ title, description, image, timescale, gitHubLink, deployedLink, technologies, inDepthDescription, isModalOpen, openModal, closeModal }) {
  useEffect(() => {
  ...
  return (
    <section id="projects" className="h-screen flex flex-col justify-center items-center bg-gray-800 text-white text-center">
